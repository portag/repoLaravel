...
<body class="">
    <nav class="navbar navbar-expand-lg text-bg-success text-light">
        <div class="container-fluid text-light">

            <a class="navbar-brand text-light" href="#">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    class="bi bi-controller text-light fs-5 mx-1" viewBox="0 0 16 16">
                    <path
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    @auth
                        <li><a class="nav-link scrollto text-light" href="/profile"><svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    @else
                        <li><a class="nav-link scrollto text-light" href="{{ route('login') }}">Login</a></li>
                        @if (Route::has('register'))
                            <li><a class="nav-link scrollto text-light" href="{{ route('register') }}">Register</a></li>
                        @endif
                    @endauth
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                            ...
                            <h6 class="text-uppercase fw-bold mb-4">
                                <i class="fas fa-gem me-3"></i>Arena games
                            </h6>
                            <p>
                                Arena games es una pagina especializada en eventos de videojuegos principalmente
                                multijugador
                            </p>
                        </div>
                        <!-- Grid column -->
                        ...
                        <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                            ...
                            <p>
                                <a href="#!" class="text-reset">Figuras</a>
                            </p>
                            <p>
                                <a href="#!" class="text-reset">Directos</a>
                            </p>
                        ...
                        <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                            ...
                            <p>
                                <a href="#!" class="text-reset">Canal twitch</a>
                            </p>
                            <p>
                                <a href="#!" class="text-reset">Canal youtube</a>
                            </p>
